...
const PromoCode = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const errors = {};
    if (!formData.number || formData.number <= 0) errors.number = "Code is required";
    ...
    toast.success("Redeem points Added");
    setFormData({
        number: "",
    });
    setOpen(false);
  ...
  return (
    <div style={{height:"100%"}}>
      <Box sx={styles.btn} onClick={handleOpen}>Promo Code</Box>
      <Modal
        open={open}
        onClose={handleClose}
          ...
          <Box style={styles.form}>
            ...
            <div style={styles.row}>
              <div style={styles.inputGrp}>
                <FormLabel style={{color:"white"}}>Promo Code</FormLabel>
                <TextField
                  required
                  fullWidth
                  id="number"
