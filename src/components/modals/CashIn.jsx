...
//   const dispatch = useDispatch();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const response = await axios.post(CASH_IN, formData);
        
        
        toast.success('Cash In successfully added');
  ...
  return (
    <div style={{height:"100%"}}>
      <Box sx={styles.btn} onClick={handleOpen}>Cash In</Box>
      <Modal
        open={open}
        onClose={handleClose}
